    ...
    return (
        <>
            <div className='aboutUs w-100 mb-5 shadow rounded-4 overflow-hidden'>
                <div className='d-flex align-items-center '>
                    ...
                    <figure className='m-0' style={{ flex: 1 }}>
                        <img src={gasfitero} alt="" className='img-fluid w-100 h-100 object-fit-cover' />
                    </figure>
            ...
            <div className='aboutUs w-100 mx-auto shadow rounded-4 overflow-hidden'>
                <div className='d-flex align-items-center '>
                    <figure className='m-0' style={{ flex: 1 }}>
                        <img src={gasfitero1} alt="" className='img-fluid w-100 h-100 object-fit-cover' />
                    </figure>
                    <div className='px-5 text-start' style={{ flex: 3 }}>
